    ...
    <nav className="navbar text-white md:px-20 z-50 fixed top-0 w-full bg-lime-600 rounded-b-2xl">
      <div className="flex items-center justify-between w-full px-4 md:px-0">
        ...
        <div className="hidden md:flex space-x-6">
          <Link href="https://wa.me/6282213772860" target="_blank" className="bg-white text-lime-700 font-semibold px-4 py-2 rounded-lg hover:bg-lime-700 hover:text-white transition">
            {" "}
      ...
      {isOpen && (
        <div className="md:hidden absolute right-0 top-full mt-0 bg-white rounded-bl-lg shadow-lg w-64">
          <div className="flex flex-col py-4 w-full">
            <Link href="https://wa.me/6282213772860" target="_blank" className="px-8 py-3 text-lime-700 font-medium hover:bg-gray-100">
              {lang == "id" ? "Hubungi Kami" : "Contact Us"}
            </Link>
