    ...
    <div className="scroll-smooth">
      <header className="w-100 h-screen relative" id="landing">
        ...
        <div className="h-full flex flex-col items-center justify-evenly relative z-10">
          <h1 className="text-white font-semibold text-4xl md:text-4xl text-center text-pretty md:max-w-[60%]">Wujudkan ruang hijau impian Anda bersama Kanigara Nurseries – kualitas terbaik, layanan profesional.</h1>
          <summary className="text-center text-pretty md:max-w-[60%] px-2 md:px-0">
            <h2 className="text-white text-lg md:text-2xl font-sans">Selamat datang di Kanigara Nurseries! - Kami hadir sebagai solusi untuk menciptakan lanskap hijau yang berkualitas dan berkelanjutan.</h2>
            <div className="mt-4">
              <a href="#about" className="px-4 py-2 bg-lime-600 text-white font-semibold rounded-full hover:bg-lime-700 text-xl">
                Mulai Jelajahi
              </a>
            </div>
          </summary>
      ...
      <About lang="id" />
      <OurAdvantage lang="id" />
      <AboutUs lang="id" />
      <WhyUs lang="id" />
      <VirtualTour lang="id" />
      <Materials lang="id" materials={materials} />
